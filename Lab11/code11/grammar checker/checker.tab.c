...
#line 83 "checker.tab.c" /* yacc.c:339  */
...
#line 141 "checker.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "SUBJECT", "VERB", "OBJECT", "DOT",
...
#line 1205 "checker.tab.c" /* yacc.c:1646  */
      default: break;
    }
